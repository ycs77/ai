...
- Read and query ordinary project data; protected resources remain subject to stricter rules
- Version checks
...
AI generates destructive commands the user never asked for—in a real incident, a harmless task led the AI to spontaneously run recursive deletion, wiping the entire system drive. **Define policy by behavior category and consequence, not by a list of specific commands.**
